...
Nonetheless, the reverse sorted inputs get sorted at most 10\% faster than the sorted ones.
...
The exception are reverse sorted inputs, where bottom-up \HS{} also shows a slight upwards trend.
...
Indeed, at around 2000 elements, the bottom-up \HS{} with swap disparity overtakes the top-down \HS{} because of their inverse trends, but the lead stays meagre even at 6000 elements.
