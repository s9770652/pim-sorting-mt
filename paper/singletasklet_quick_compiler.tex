...
\begin{itemize}
	\item
	\dots{} a lengthening of the loop finding the next element to move to the right of the pivot from three instructions to four, \dots{}

	\item
	\dots{} an additional instruction after such an element to move has been found, \dots{}

	\item
	\dots{} an additional instruction when swapping elements, and \dots{}

	\item
	\dots{} more stores and loads
\end{itemize}
