...
\begin{figure}
	...
	\caption{
		Comparison of \MS*{}, which need an auxiliary array of length either \(n\) (\enquote{No Write-back} / \enquote{Write-back}) or \(n/2\) (\enquote{Half-Space}), for different lengths of the starting runs.
