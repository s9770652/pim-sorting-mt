...
\begin{figure}
	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\nextgroupplot[title/.add={}{Without Write-Backs}, legend to name=leg:merge:starting_runs]
	...
	\caption{
		Average runtimes of the full-space \MS*{} with and without write-backs and the half-space \MS{}, for different lengths of the starting runs.
	}
...
The measurements show that the \MS*{} guarantee a runtime of \(\bigoh{n \log n}\) as expected.
