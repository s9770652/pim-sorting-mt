	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\pgfplotsinvokeforeach{1,...,9}{
				\plotpernn[x filter/.expression={x > #1 ? x : nan}]{#1}{\tableSmallSortsXxxiiUniform}
			}
			%
...
Implicit sentinel values could provide relief since the slow-down from implicitness should trend to zero for large inputs, as was the case for \IS{}.
\todo[inline]{\enquote{%
