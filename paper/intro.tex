...
As a consequence, the performance of a processor core has grown by up to \qty{52}{\percent} year after year, whilst the latency of \ac{DRAM}, for example, has been improving only by \qty{7}{\percent} (see \cref{fig:intro:memory wall}).
