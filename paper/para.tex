...
To inform others on \emph{which} elements they have to sort, a WRAM array is employed whither the particular indices are written by the tasklets performing the partitioning.
