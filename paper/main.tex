...
\pgfplotsset{
	height=4cm,
	/tikz/trim axis group left, /tikz/trim axis group right,  % Only axes define the bounding box. Thus, lables can extend into the margins.
	/pgfplots/every legend to name picture/.append style={  % Legends outside (added via \pgfplotslegendfromname) have their bounding box reset.
	...
	enlargelimits=auto,  % for axes without specified limits, the limits are a bit bigger than neeeded (→ padding)
	...
	group style={horizontal sep=5em},
}
