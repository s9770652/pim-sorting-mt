\documentclass[overfullrule, british, oneside]{../garticle}
...
\pgfplotsset{
	...
	horizontal sep for labels/.style={group/horizontal sep=18mm},  % padding between groupplots (ticks + labels)
	horizontal sep for ticks/.style={group/horizontal sep=10mm},  % padding between groupplots (labels)
	horizontal sep for naught/.style={group/horizontal sep=3mm},  % padding between groupplots (/)
