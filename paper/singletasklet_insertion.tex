...
\begin{figure}
	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\plotpernn{1NoSentinel}{tableSmallSorts_32uniform}
			\plotpernn{1}{tableSmallSorts_32uniform}
			\plotpernn{1Implicit}{tableSmallSorts_32uniform}
			\plotpernn{BubbleNonAdapt}{tableSmallSorts_32uniform}
			\plotpernn{BubbleAdapt}{tableSmallSorts_32uniform}
			\plotpernn{Selection}{tableSmallSorts_32uniform}
			%
			\nextgroupplot[ylabel=Speed-up, ymin=0.2, ymax=1, yticklabel style={/pgf/number format/.cd, precision=1, fixed, zerofill}]
			\plotspeedup{1NoSentinel}{1}{tableSmallSorts_32uniform}
			\pgfplotsset{cycle list shift=1}
			\plotspeedup{1Implicit}{1}{tableSmallSorts_32uniform}
			\plotspeedup{BubbleNonAdapt}{1}{tableSmallSorts_32uniform}
			\plotspeedup{BubbleAdapt}{1}{tableSmallSorts_32uniform}
			\plotspeedup{Selection}{1}{tableSmallSorts_32uniform}
		\end{groupplot}
	\end{tikzpicture}
