...
Let us first focus on short inputs where only two passes with step sizes~\(\stepsizes_1\) and \(1\) suffice.
...
\begin{figure}[!b]
	...
	\caption{
		Comparison of \IS{} (1) and various two-tier \ShS*{} (2--9), whose step sizes \(\stepsizes_1\) are given in the legend.
...
\Citeauthor{10.1007/3-540-44669-9_12} calculated an average speed-up of 33\% over doing two passes, while it is only 16\% on a DPU.
