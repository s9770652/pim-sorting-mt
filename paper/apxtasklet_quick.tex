...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\plotpernlognwitherrors{TrivialBC}{tableQuickDet_32normal}
			\plotpernlognwitherrors{TrivialBC}{tableQuickRand_32normal}
		\end{groupplot}
	\end{tikzpicture}
...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			%
			\nextgroupplot[title/.add={}{Normal}]
			\plotpernlognwitherrors{TrivialBC}{tableQuickDet_64normal}
			\plotpernlognwitherrors{TrivialBC}{tableQuickRand_64normal}
		\end{groupplot}
	\end{tikzpicture}
