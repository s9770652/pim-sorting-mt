...
At times, the quality of the compilation nosedives, and \IS{} shall serve as an example.
When sorting an element, all previous elements must already be in sorted order;
an implementation of this is shown in \cref{fig:insertion:impl:pred_first}.
...
Multiple workarounds exist to circumvent this problem.
...
Unluckily, the struggle with the compiler endeth not herewith.
...
\begin{figure}
	\begin{subfigure}{0.471\linewidth}
		\begin{lstlisting}
