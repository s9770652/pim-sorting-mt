...
This \lcnamecref{sec:tasklet} is concerned with the very first phase where each tasklet sorts on its own, that is sequentially.
...
The meaning behind and reasoning for the individual parameters in the configurations are subject in \crefrange{sec:tasklet:insertion}{sec:tasklet:merge} but shall be mentioned here already for easy look-up:
\begin{description}
	\item[\IS{}]
