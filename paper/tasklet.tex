...
Key characteristics of the \ac{DPU} architecture which are of especial importance in this \lcnamecref{sec:tasklet} are the uniform access to \ac{WRAM} data and the uniform cost of instructions.
