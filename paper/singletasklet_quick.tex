...
\pgfplotstableread{data/quick/rec_vs_it.txt}{\tablequickrecvsit}
...
%			\plotpernlogn{It}{\tablequickrecvsit}
%			\plotpernlogn{Rec}{\tablequickrecvsit}
%			%
%			\nextgroupplot[ylabel=Speed-up]
%			\plotspeedup{It}{Rec}{\tablequickrecvsit}
%		\end{groupplot}
%	\end{tikzpicture}
%
...
\begin{itemize}
	...
	\item
	A \emph{random element} is most efficiently drawn using a xorshift random number generator and rejection sampling\todo{LG-Quelle}.
\end{itemize}
