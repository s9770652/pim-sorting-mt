...
As \cref{fig:quick_fallback} demonstrates, the optimal threshold for switching the sorting algorithm is around 13 elements, netting a speed-up of 30\% and more over a \QS{} without fallback algorithm.
This low threshold also means that even a simple two-round \ShS{} is not worth considering.

\begin{figure}
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			width=0.4359\linewidth,
...
\begin{figure}
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\nextgroupplot[ylabel=Cycles / \((n \lb n)\), ymin=55, ymax=70, legend to name=leg:pivot]
	...
	\hfil\pgfplotslegendfromname{leg:pivot}\hfil
	\caption{
