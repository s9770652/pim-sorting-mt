...
For 64-bit integers, the optimal threshold is 17 elements, but since the difference are minuscule, we set 18 elements to be the default threshold for both data types.
