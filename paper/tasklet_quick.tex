...
However, these input distributions should be catered for by a pattern-defeating \QS{} as laid out in \cref{subsec:tasklet:conclusion}, hence the 18 elements as default threshold.
