...
\label{subsec:app:single:insertion}
...
\begin{figure}[h]
	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\nextgroupplot[title={Sorted}, legend to name=leg:insertion:all_distributions_uint32]
	...
	\hfil\pgfplotslegendfromname{leg:insertion:all_distributions_uint32}\hfil
	\caption{
		A continuation of \cref{fig:insertion:against_others} with more input distributions.
		The data type is 32-bit integers.
	}
	\label{fig:insertion:all_distributions_uint32}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\nextgroupplot[title={Sorted}, legend to name=leg:insertion:all_distributions_uint64]
			\legend{\IS{} (no sentinel), \IS{} (sentinel), \IS{} (implicit), \BS{} (not adaptive), \BS{} (adaptive), \SelS{}}
			\expandafter\pgfplotsinvokeforeach\expandafter{\algos}{
	...
	\hfil\pgfplotslegendfromname{leg:insertion:all_distributions_uint64}\hfil
	\caption{
		A continuation of \cref{fig:insertion:against_others} with more input distributions.
		The data type is 64-bit integers.
	}
	\label{fig:insertion:all_distributions_uint64}
\end{figure}
