...
\NewDocumentCommand{\shellscatter}{m m}{
	\addplot+ plot [select coords between index={#1}{#1}] table [x=µ_#2, y=σ_#2] {\tableshellx};
	...
	\addplot+ plot [select coords between index={#1}{#1}, forget plot] table [x=µ_#2, y=σ_#2] {\tableshellxvii};
	\ifnumless{#2}{7}{
...
\begin{figure}[p]
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\legend{\(h_2 = 3\), \(h_2 = 4\), \(h_2 = 5\), \(h_2 = 6\), \(h_2 = 7\), \(h_2 = 8\), \(h_2 = 9\), Quick, Ciura}
			\pgfplotsinvokeforeach{3,...,9}{
				\shellscatter{5}{#1}
			}
