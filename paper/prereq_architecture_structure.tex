...
Also, despite the theoretical maximum bandwidth of \qty{17.9}{\gibi\byte\per\second} of \ac{DDR}-2400\todo{Darf man überhaupt so rechnen?}, the empirically measured bandwidth of a \acp{DMA} is \qty{603}{\mebi\byte\per\second} on a v1A \ac{DPU}.
