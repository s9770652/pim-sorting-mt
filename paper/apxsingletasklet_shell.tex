	...
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsXxxiiSorted}
			}
			%
			\nextgroupplot[title={Reverse Sorted}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsXxxiiReverse}
			}
			%
			\nextgroupplot[title={Almost Sorted}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsXxxiiAlmost}
			}
			%
			\nextgroupplot[title={Uniform}]
			\pgfplotsset{cycle list shift=1}
			...
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsXxxiiZipf}
			}
			%
			\nextgroupplot[title={Normal}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsXxxiiNormal}
			}
		\end{groupplot}
	\end{tikzpicture}
...
\begin{figure}
	\begin{tikzpicture}[plot]
		\begin{groupplot}[
			...
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsLxivSorted}
			}
			%
			\nextgroupplot[title={Reverse Sorted}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsLxivReverse}
			}
			%
			\nextgroupplot[title={Almost Sorted}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsLxivAlmost}
			}
			%
			\nextgroupplot[title={Uniform}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsLxivUniform}
			}
			%
			\nextgroupplot[title={Zipf's}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsLxivZipf}
			}
			%
			\nextgroupplot[title={Normal}]
			\pgfplotsset{cycle list shift=1}
			\pgfplotsinvokeforeach{2,...,9}{
				\plotspeedup{#1}{1}{\tableSmallSortsLxivNormal}
			}
		\end{groupplot}
	\end{tikzpicture}
