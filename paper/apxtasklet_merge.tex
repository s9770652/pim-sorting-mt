...
\begin{figure}
	...
	\caption{
		...
		For starting run length \startingrun{}, the input lengths \(n = 4^i \cdot \startingrun + 1\) with \(i = 0, \dots, 4\) were tested.
		The date size is 32 bit.
	}
...
\begin{figure}
	...
	\caption{
		\MS{} with different starting run lengths.
		For starting run length \startingrun{}, the input lengths \(n = 4^i \cdot \startingrun + 1\) with \(i = 0, \dots, 3\) were tested.
		The date size is 32 bit.
	}
